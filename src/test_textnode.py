...
class TestTextNode(unittest.TestCase):
    def test_eq(self):
        node = TextNode("This is a text node", TextType.BOLD, 'https://123')
        node2 = TextNode("This is a text node", TextType.BOLD, 'https://123')
    ...
    def test_not_eq_text(self):
        node = TextNode("This is a text node", TextType.BOLD)
        node2 = TextNode("NOT EQUAL TEXT", TextType.BOLD)
